...
class Verify extends Component {
    componentDidMount = () => {
        this.props.verification(this.props.match.params.email);
    }
    ...
    render() {
        return (
            <div>
                ...
                <p className="landingSubTitle">VERIFICATION COMPLETED!!</p>
                <p className="landingText">Congrats! Now go login to get some gains!</p>
                <div className="authContainer">
                    <button className="landingAuth" onClick={()=> this.props.history.push('/profile')}>Login</button>
