...
import { followersList } from '../../actions';
        ...
        if (following.length >= 1) {
                ...
                <div className="postContainer">
                    <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                        <div className="dropdown">
                            <button className={"dropbtn"}><i className={"fa fa-user-plus"}/> Followers</button>
                        </div>
                    </div>
                    {
                        following.map(user =>
            ...
            return (
                <div>
                    ...
                    <p style={{fontSize:"20px", textAlign:"center"}}>You don't have any followers... Go invite a friend to follow you</p>
                </div>
            )
        }
    }
